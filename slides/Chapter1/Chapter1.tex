...
\begin{columns}
	...
	\begin{block}{教材}
	李长河, 童恒建等, \alert{C++程序设计（基于C++11标准）}. 电子工业出版社, 2018年8月, ISBN：9787121343520
	\end{block}
\begin{block}{参考书}
	Stanley B. Lippman，Jos\'{e}e Lajoie，Barbara E. Moo．C++ Primer（第五版）．王刚等译．北京：电子工业出版社，2013．	
	\end{block}
\begin{block}{电子资源}
课程PPT，教材代码，实验指导书：\\{\footnotesize \url{https://github.com/Changhe160/book-cplusplus}} 
	\end{block}
	\end{column}
	\hfill
	\begin{column}{0.4\textwidth}
		\begin{figure}[ht]
			\centering
			\includegraphics[scale=1.0]{book.jpg}
		\end{figure}
	\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.8\textwidth}
    \begin{block}{统计联系方式}
    \alert{班长}利用\alert{Excel}按照以下格式统计所有学生信息，然后发给我\\
       \vspace{0.2cm}
    姓名~~~~~~~~电子邮件\\
...
%-----------------------------------------------------------
\begin{frame}[allowframebreaks,noframenumbering]           %beamer里重要的概念，每个frame定义一张page
\centering
\begin{tabular}{cc}
  \includegraphics[scale=0.5]{rank2018.png} & \includegraphics[scale=0.5]{rank2019.jpg}
\end{tabular}
	...
	\begin{itemize}
        ...
        \item \texttt{C++}有两种注释方法
            \begin{itemize}
                ...
                \item 界定符\texttt{(/*~*/)}注释多行语句，以\texttt{/*}开始，到\texttt{*/}结束
            \end{itemize}
	\end{itemize}
\end{yellowblock}
\end{columns}
