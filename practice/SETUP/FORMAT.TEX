...
\definecolor{darkred}{rgb}{0.6,0,0}%暗红
\definecolor{lightred}{rgb}{1.0,0.81,0.81}%浅红
...
\def\makecover{
    ...
    \parbox[t][3cm][c]{\textwidth}{\begin{center} {\linghao\hei\@ctitle}\end{center} }
    \parbox[t][4.0cm][c]{\textwidth}{\begin{center} {\sanhao\@cauthor}\end{center} }
    \parbox[t][8cm][b]{\textwidth}{\begin{center} {\sanhao\@publisher} \end{center} }
    \end{center}
    \end{titlepage}
    \normalsize
   }
