...
%--------------------------------------------------------------------------------------------------------------------------
%new
\usepackage{xcolor,listings}              % C++ code
\usepackage{fourier}
\usepackage{tabularx}
\usepackage{tcolorbox}
\usepackage[flushleft]{threeparttable}  % 嵌套的表格注解
\usepackage{imakeidx}                          % 使用index索引
%\usepackage{ccmap}%支持pdf中文复制
